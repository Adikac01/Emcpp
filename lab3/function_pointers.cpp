...
typedef double (*sqrtnPtr)(int, double);
typedef double (*powerPtr)(double, double);
typedef double (*functionPtr)(int, double, double, sqrtnPtr, powerPtr);


int main(){
   double (*fp1)(int, double) = sqrtn;
   double (*fp2)(double, double) = power;
	functionPtr fp3 = function<sqrtnPtr, powerPtr>;
